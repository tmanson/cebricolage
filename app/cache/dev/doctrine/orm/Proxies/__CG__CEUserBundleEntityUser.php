...
namespace Proxies\__CG__\CE\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \CE\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'CE\\UserBundle\\Entity\\User' . "\0" . 'identifiant', '' . "\0" . 'CE\\UserBundle\\Entity\\User' . "\0" . 'firstname', '' . "\0" . 'CE\\UserBundle\\Entity\\User' . "\0" . 'phoneNumber', 'groups', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
