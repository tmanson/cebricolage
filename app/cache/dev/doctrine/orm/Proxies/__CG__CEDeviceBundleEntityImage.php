 ...
 */
class Image extends \CE\DeviceBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CE\\DeviceBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'CE\\DeviceBundle\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'CE\\DeviceBundle\\Entity\\Image' . "\0" . 'alt', 'file'];
        }
