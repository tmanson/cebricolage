...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'ce_user.group.form.type' => 'getCeUser_Group_Form_TypeService',
            'ce_user.registration.form.type' => 'getCeUser_Registration_Form_TypeService',
    ...
    /**
     * Gets the 'ce_user.group.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CE\UserBundle\Form\Type\GroupFormType A CE\UserBundle\Form\Type\GroupFormType instance.
     */
    protected function getCeUser_Group_Form_TypeService()
    {
        return $this->services['ce_user.group.form.type'] = new \CE\UserBundle\Form\Type\GroupFormType();
    }

    /**
     * Gets the 'ce_user.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CE\UserBundle\Form\Type\RegistrationFormType A CE\UserBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getCeUser_Registration_Form_TypeService()
    {
        return $this->services['ce_user.registration.form.type'] = new \CE\UserBundle\Form\Type\RegistrationFormType();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'cebricolage', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\CE\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\CE\\DeviceBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\CE\\ReservationBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'CE\\UserBundle\\Entity');
        $c->addDriver($b, 'CE\\DeviceBundle\\Entity');
        $c->addDriver($b, 'CE\\ReservationBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('CEUserBundle' => 'CE\\UserBundle\\Entity', 'CEDeviceBundle' => 'CE\\DeviceBundle\\Entity', 'CEReservationBundle' => 'CE\\ReservationBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d21134f25fd83fefc9600c1f9308f3aaac6b511b96777aaa02b755431bcb61d9');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('CE\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.group.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_group_form', 'ce_user_group', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.group.form.type'] = new \FOS\UserBundle\Form\Type\GroupFormType('CE\\UserBundle\\Entity\\Group');
    }
    ...
    {
        return $this->services['fos_user.group_manager'] = new \FOS\UserBundle\Doctrine\GroupManager($this->get('fos_user.object_manager'), 'CE\\UserBundle\\Entity\\Group');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('CE\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'ce_user_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('CE\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('CE\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('fos_user.object_manager'), 'CE\\UserBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/[0-9]+/show');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/[0-9]+/.+');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/.+');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/group/new$');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/group/.*$');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/group/.+/.*');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/reservation/$');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/reservation/[0-9]+/show');

        $p = new \Symfony\Component\HttpFoundation\RequestMatcher('^/reservation/.+');

        $q = new \Symfony\Component\HttpFoundation\RequestMatcher('^/get_emprunt');

        $r = new \Symfony\Component\HttpFoundation\RequestMatcher('^/get_reservation');

        $s = new \Symfony\Component\HttpFoundation\RequestMatcher('^/device_create');

        $t = new \Symfony\Component\HttpFoundation\RequestMatcher('^/device_edit/[0-9]+');

        $u = new \Symfony\Component\HttpFoundation\RequestMatcher('^/login$');

        $v = new \Symfony\Component\HttpFoundation\RequestMatcher('^/register');

        $w = new \Symfony\Component\HttpFoundation\RequestMatcher('^/resetting');

        $x = new \Symfony\Component\Security\Http\AccessMap();
        $x->add($g, array(0 => 'ROLE_READ_USER'), NULL);
        $x->add($h, array(0 => 'ROLE_READ_USER'), NULL);
        $x->add($i, array(0 => 'ROLE_CRUD_USER'), NULL);
        $x->add($j, array(0 => 'ROLE_CRUD_USER'), NULL);
        $x->add($k, array(0 => 'ROLE_CRUD_GROUP'), NULL);
        $x->add($l, array(0 => 'ROLE_READ_GROUP'), NULL);
        $x->add($m, array(0 => 'ROLE_CRUD_GROUP'), NULL);
        $x->add($n, array(0 => 'ROLE_READ_RESERVATION'), NULL);
        $x->add($o, array(0 => 'ROLE_READ_RESERVATION'), NULL);
        $x->add($p, array(0 => 'ROLE_CRUD_RESERVATION'), NULL);
        $x->add($q, array(0 => 'ROLE_READ_RESERVATION'), NULL);
        $x->add($r, array(0 => 'ROLE_READ_RESERVATION'), NULL);
        $x->add($s, array(0 => 'ROLE_CRUD_DEVICE'), NULL);
        $x->add($t, array(0 => 'ROLE_CRUD_DEVICE'), NULL);
        $x->add($u, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $x->add($v, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $x->add($w, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        ...
        $aa->setOptions(array('login_path' => 'fos_user_security_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $ba->setOptions(array('login_path' => 'fos_user_security_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($x, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username')), 'main', $a, $c), 2 => $z, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $y, 'main', $aa, $ba, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '57976a2e4ffbd3.33951018', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $x, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $y, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $y, 'fos_user_security_login', false), NULL, NULL, $a, false));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\CE\\CoreBundle/Resources/views'), 'CECore');
        $instance->addPath(($this->targetDirs[3].'\\src\\CE\\UserBundle/Resources/views'), 'CEUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\CE\\DeviceBundle/Resources/views'), 'CEDevice');
        $instance->addPath(($this->targetDirs[3].'\\src\\CE\\ReservationBundle/Resources/views'), 'CEReservation');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_READ_USER' => array(0 => 'ROLE_USER', 1 => 'IS_AUTHENTICATED_REMEMBERED'), 'ROLE_CRUD_USER' => array(0 => 'ROLE_READ_USER'), 'ROLE_READ_GROUP' => array(0 => 'ROLE_USER', 1 => 'IS_AUTHENTICATED_REMEMBERED'), 'ROLE_CRUD_GROUP' => array(0 => 'ROLE_READ_GROUP'), 'ROLE_READ_RESERVATION' => array(0 => 'ROLE_USER', 1 => 'IS_AUTHENTICATED_REMEMBERED'), 'ROLE_CRUD_RESERVATION' => array(0 => 'ROLE_READ_RESERVATION'), 'ROLE_READ_DEVICE' => array(0 => 'ROLE_USER', 1 => 'IS_AUTHENTICATED_REMEMBERED'), 'ROLE_CRUD_DEVICE' => array(0 => 'ROLE_READ_DEVICE'), 'ROLE_ADMIN' => array(0 => 'ROLE_CRUD_USER', 1 => 'ROLE_CRUD_RESERVATION', 2 => 'ROLE_CRUD_GROUP', 3 => 'ROLE_CRUD_DEVICE'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CECoreBundle' => 'CE\\CoreBundle\\CECoreBundle',
                'CEUserBundle' => 'CE\\UserBundle\\CEUserBundle',
                'CEDeviceBundle' => 'CE\\DeviceBundle\\CEDeviceBundle',
                'CEReservationBundle' => 'CE\\ReservationBundle\\CEReservationBundle',
            ...
            'security.role_hierarchy.roles' => array(
                'ROLE_READ_USER' => array(
                    0 => 'ROLE_USER',
                    1 => 'IS_AUTHENTICATED_REMEMBERED',
                ),
                'ROLE_CRUD_USER' => array(
                    0 => 'ROLE_READ_USER',
                ),
                'ROLE_READ_GROUP' => array(
                    0 => 'ROLE_USER',
                    1 => 'IS_AUTHENTICATED_REMEMBERED',
                ),
                'ROLE_CRUD_GROUP' => array(
                    0 => 'ROLE_READ_GROUP',
                ),
                'ROLE_READ_RESERVATION' => array(
                    0 => 'ROLE_USER',
                    1 => 'IS_AUTHENTICATED_REMEMBERED',
                ),
                'ROLE_CRUD_RESERVATION' => array(
                    0 => 'ROLE_READ_RESERVATION',
                ),
                'ROLE_READ_DEVICE' => array(
                    0 => 'ROLE_USER',
                    1 => 'IS_AUTHENTICATED_REMEMBERED',
                ),
                'ROLE_CRUD_DEVICE' => array(
                    0 => 'ROLE_READ_DEVICE',
                ),
                'ROLE_ADMIN' => array(
                    0 => 'ROLE_CRUD_USER',
                    1 => 'ROLE_CRUD_RESERVATION',
                    2 => 'ROLE_CRUD_GROUP',
                    3 => 'ROLE_CRUD_DEVICE',
                ),
            ...
            'fos_user.model.user.class' => 'CE\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.form.type' => 'ce_user_registration',
            ...
            'fos_user.model.group.class' => 'CE\\UserBundle\\Entity\\Group',
            'fos_user.group.form.type' => 'ce_user_group',
