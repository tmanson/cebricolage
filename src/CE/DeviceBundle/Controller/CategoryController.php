...
use CE\DeviceBundle\Form\CategoryType;
...
class CategoryController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('CEDeviceBundle:Category:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CEDeviceBundle:Category')->find($id);
        ...
        return $this->render('CEDeviceBundle:Category:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('CEDeviceBundle:Category:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new CategoryType($entity->getId()), $entity, array(
